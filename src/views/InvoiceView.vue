  ...
  <div class="invoice-view container">
    ...
    <div class="header flex">
      ...
      <div class="right flex">
        ...
        <button class="green" v-if="currentInvoice.invoicePending" @click="updateStatusToPaid(currentInvoice.docId)">
          Mark as Paid
        </button>
        <button class="orange" v-if="currentInvoice.invoiceDraft || currentInvoice.invoicePaid" @click="updateStatusToPending(currentInvoice.docId)">
          Mark as Pending
        </button>
      </div>
    </div>
